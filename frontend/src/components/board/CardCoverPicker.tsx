...
import { CARD_COVER_COLORS } from '../../lib/constants'
...
export const CardCoverPicker: React.FC<CardCoverPickerProps> = ({
  currentCoverColor,
  ...
  return (
    <div className="absolute right-0 top-12 w-72 bg-base-100 border border-base-200 shadow-xl rounded-2xl p-4 z-50 space-y-4">
      ...
      <div className="flex justify-between items-center border-b border-base-200 pb-2">
        <h3 className="text-sm font-bold text-base-content">Pilih Cover Kartu</h3>
      ...
      <div className="space-y-4">
        {activeTab === 'colors' ? (
          <ColorGrid
            ...
            selectedColor={currentCoverColor}
      ...
      {/* Actions */}
      {(currentCoverColor || currentCoverImageUrl) && (
